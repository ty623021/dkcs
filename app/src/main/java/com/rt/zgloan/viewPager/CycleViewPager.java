...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private List<BannerItemInfo> infos;
...
//                            swipeRefreshLayout.setEnabled(true);
    ...
    public void setData(List<ImageView> views, List<BannerItemInfo> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<BannerItemInfo> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        void onImageClick(BannerItemInfo info, int position, View imageView);
    }
}